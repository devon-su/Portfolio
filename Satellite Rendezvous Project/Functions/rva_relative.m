...
OUTPUTS: 
rhovect - position of B relative to A in the LVLH frame
drhovect = velocity of B relative to A in the LVLH frame
ddrhovect = acceleration of B relative to A in the LVLH frame
